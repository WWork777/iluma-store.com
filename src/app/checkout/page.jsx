...
const CheckoutPage = () => {
  ...
  // Функция для проверки предыдущих заказов (ЗАКОММЕНТИРОВАНА)
  ...
  // Функция для отправки в Telegram с повторными попытками (ЗАКОММЕНТИРОВАНА)
  /*
  ...
  */
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        // 1. Проверка предыдущих заказов (ЗАКОММЕНТИРОВАНА)
...
Общая сумма: ${totalPrice} ₽
        ...
        // 4. Сохранение в базу данных (ЗАКОММЕНТИРОВАНО)
        /*
        ...
        */
        ...
        // 5. Отправка WhatsApp (ЗАКОММЕНТИРОВАНА)
        /*
...
${selectedMethod === "delivery" ? `🏙 Город: ${formData.city || "Не указан"}` : ""}`;
        ...
        */
        ...
        // Запускаем только email (остальные закомментированы)
