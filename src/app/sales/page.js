...
export const metadata = {
  ...
  description:
    "Скидки и акции в магазине IqosIluma - покупайте премиальные устройства IQOS ILUMA и стики Terea по привлекательным ценам",
  alternates: {
    canonical: `https://iluma-store.com/sales`,
  },
  openGraph: {
    title: `Скидки и акции в магазине IqosIluma`,
    ...
    url: `https://iluma-store.com/sales`,
    images: [
      {
